...
contract StarNotary is ERC721 {
    ...
    string public tokenName = "Rice For Everyone";
    string public symbolName = "RFE";
    ...
    constructor() ERC721(tokenName, symbolName){
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId2), "You can't exchange the Star!!!");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "You can't exchange the Star!!!");
