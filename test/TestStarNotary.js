...
it('lets user2 buy a star and decreases its balance in ether', async() => {
    ...
    assert.equal(x.toString() , price.toString());
});
...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar('Star 06', starId, {from: user});
    //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided
    assert.equal(await instance.name(), 'Rice For Everyone');
    assert.equal(await instance.symbol(), 'RFE');
});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Star 07', starId1, {from: user1});
    await instance.createStar('Star 08', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar('Star 09', starId, {from: user1});
